package com.suncht.tkmybatis.generator.maven.resolver;
...
/**
 * 重新实现mybatis自动生成数据类型转换
 * @author sunchangtan
 */
public class JavaTypeResolverNewImpl implements JavaTypeResolver {
    ...
    public JavaTypeResolverNewImpl() {
        super();
